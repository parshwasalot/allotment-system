...
function Login() {
    ...
    const submitValue = async (event) => {
        ...
        try {
            const response = await axios.post('https://allotment-system-backend.vercel.app/login', { username, password });
            ...
            if (response.data.flag === 1) {
                ...
                await axios.post('https://allotment-system-backend.vercel.app/logging/log-login', { username: mydata.username });
